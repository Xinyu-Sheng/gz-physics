...
public:
  ...
  public:
    virtual void
    AddLinkExternalForceInWorld(const Identity &_id,
                                const LinearVectorType &_force,
  ...
  public:
    virtual void
    AddLinkExternalTorqueInWorld(const Identity &_id,
                                 const AngularVectorType &_torque) = 0;
  };
};

/////////////////////////////////////////////////
class GZ_PHYSICS_VISIBLE SetLinkInertial : public virtual Feature {
public:
  template <typename PolicyT, typename FeaturesT>
  ...
  public:
    void SetInertial(const gz::math::Inertial<Scalar> &_inertial);
  };
...
public:
  ...
  public:
    virtual void
    SetLinkInertial(const Identity &_id,
                    const gz::math::Inertial<Scalar> &_inertial) = 0;
  };
};
} // namespace physics
} // namespace gz
